    ...
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <label className="text-sm space-y-1 block">
          <span className="text-zinc-600 dark:text-zinc-400">Job description *</span>
          <textarea
        ...
        <button
          type="submit"
          disabled={submitting}
          className="rounded-lg bg-black text-white dark:bg-white dark:text-black px-5 py-2.5 text-sm font-medium disabled:opacity-50"
        >
